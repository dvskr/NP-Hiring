...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    // Variant styles
    const variantStyles = {
      primary: 'bg-pink-700 hover:bg-pink-800 text-white shadow-sm hover:shadow-md hover:-translate-y-0.5',
      secondary: 'bg-gray-100 hover:bg-gray-200 text-gray-900 hover:shadow-sm',
      outline: 'border border-gray-300 hover:border-pink-600 text-gray-700 hover:text-pink-700 bg-transparent hover:bg-pink-50 hover:-translate-y-0.5',
