...
const COMMON_REQUIREMENTS = [
  { step: 1, text: 'MSN or DNP from accredited program', img: 'https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/employers/clay-star.webp' },
  { step: 2, text: 'ANCC APRN-BC certification', img: 'https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/employers/clay-envelope.webp' },
  { step: 3, text: 'State APRN license application', img: 'https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/employers/clay-briefcase.webp' },
  { step: 4, text: 'NPI number registration', img: 'https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/employers/clay-people.webp' },
  { step: 5, text: 'DEA registration for prescribing', img: 'https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/employers/clay-dollar.webp' },
  { step: 6, text: 'State-specific CE requirements', img: 'https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/employers/clay-calendar.webp' },
];
...
const AUTHORITY_CONFIG = {
  ...
  reduced: {
    ...
    bg: '#FEF3C7',
    border: '#FCD34D',
    img: 'https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/employers/clay-calendar.webp',
  },
  restricted: {
...
export default function LicensureChecker({ stateGuides, stateSalaries, practiceAuthority }: Props) {
  ...
  const result = useMemo(() => {
    ...
    const extraReqs = auth.authority === 'full' ? [] :
      auth.authority === 'reduced' ? [{ step: 7, text: 'Secure collaborative physician agreement', img: 'https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/clay-icon-connect.webp' }] :
      [{ step: 7, text: 'Secure supervising physician agreement', img: 'https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/clay-icon-connect.webp' }];
  ...
  return (
    <div style={{ ...clayCard, padding: '0', overflow: 'hidden', border: '2px solid rgba(13,148,136,0.12)' }}>
      ...
      <div style={{
        ...
        <Image src="https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/employers/clay-chart.webp" alt="Licensure Checker" width={52} height={52} style={{
      ...
      {!result ? (
        <div style={{ padding: '48px 32px', textAlign: 'center' }}>
          <Image src="https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/clay-icon-match.webp" alt="Select a state" width={72} height={72} style={{ width: '72px', height: '72px', margin: '0 auto 16px', opacity: 0.4 }} />
        ...
        <div className="lic-results-body" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0' }}>
          ...
          <div style={{ padding: '28px 32px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
            ...
            <div style={{
              ...
              <Image src="https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/employers/clay-calendar.webp" alt="Timeline" width={44} height={44} style={{ width: '44px', height: '44px', borderRadius: '14px' }} />
              <div>
            ...
            {result.salary && (
              <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '10px' }}>
                  <Image src="https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/employers/clay-dollar.webp" alt="Salary" width={36} height={36} style={{ width: '36px', height: '36px', borderRadius: '10px' }} />
                  <div>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '10px' }}>
                <Image src="https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/employers/clay-star.webp" alt="Info" width={24} height={24} style={{ width: '24px', height: '24px', borderRadius: '6px' }} />
