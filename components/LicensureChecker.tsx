  ...
  return (
    <div style={{ ...clayCard, padding: '0', overflow: 'hidden', border: '2px solid rgba(13,148,136,0.12)' }}>
      ...
      <div style={{
        ...
        <CopyCitation citation={`${brand.name}. "2026 ${brand.niche.short} State Licensure Checker: Practice Authority & Requirements by State." ${brand.name}, April 2026, pmhnphiring.com/resources.`} />
