    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      ...
      <div>
        ...
        <input
          ...
          className={`w-full min-h-[44px] rounded-lg border px-3.5 py-2.5 text-sm transition-colors focus:outline-none focus:ring-2 focus:ring-offset-1 ${errors.email
      ...
      <div>
        ...
        <select
          id="frequency"
          className="w-full min-h-[44px] rounded-lg border border-slate-300 px-3.5 py-2.5 text-sm bg-white transition-colors focus:outline-none focus:ring-2 focus:ring-offset-1 focus:border-pink-600 focus:ring-pink-600"
          {...register('frequency')}
        >
      ...
      <button
        type="submit"
        disabled={isLoading}
        className="w-full min-h-[44px] rounded-lg bg-pink-700 px-4 py-2.5 text-sm font-semibold text-white transition-all hover:bg-pink-800 focus:outline-none focus:ring-2 focus:ring-pink-600 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
      >
        {isLoading ? (
          <>
            <svg
