    ...
    <div className="flex flex-col items-center gap-3">
      ...
      <div className="relative group">
        <div className="w-24 h-24 rounded-full border-2 border-gray-300 overflow-hidden bg-gray-100 flex items-center justify-center">
          {uploading ? (
            <Loader2 className="w-8 h-8 text-pink-700 animate-spin" />
          ) : displayUrl ? (
            <Image
              src={displayUrl}
              alt="Profile avatar"
      ...
      <div className="flex items-center gap-3">
        <button
          ...
          className="text-sm text-pink-700 hover:text-pink-800 font-medium flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
        >
