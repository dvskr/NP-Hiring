...
const STEPS = [
    { img: 'https://sggccmqjzuimwlahocmy.supabase.co/storage/v1/object/public/site-assets/images/step-employer-post.webp', title: 'Post Your Listing', desc: 'Start from a NP template or generate the full description with AI. Set required experience and your post is live in 5 minutes — first 2 free.' },
    { img: 'https://sggccmqjzuimwlahocmy.supabase.co/storage/v1/object/public/site-assets/images/step-employer-reach.webp', title: 'Reach Every NP', desc: 'Your listing surfaces in semantic search, the weekly digest, and new-grad-friendly filters — plus its own indexed SEO page on Google.' },
