...
export const TOKEN_REFRESH_INTERVAL = 15; // minutes
export const PROFILE_REFRESH_INTERVAL = 30; // minutes
...
export const FILL_DELAYS: Record<string, number> = {
    fast: 25,
    normal: 50,
    careful: 150,
};

export const AI_RESPONSE_LENGTHS: Record<string, number> = {
    brief: 150,
    standard: 300,
    detailed: 500,
};
...
export const DEFAULT_SETTINGS = {
    ...
    fillSpeed: 'normal' as const,
    autoOpenReviewSidebar: true,
    useAIForOpenEnded: true,
    aiResponseLength: 'standard' as const,
    alwaysReviewAI: true,
...
// US state name ↔ abbreviation map for dropdown matching
...
export const STATE_ABBREVIATION_TO_NAME: Record<string, string> = Object.fromEntries(
