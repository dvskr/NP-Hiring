/**
 * /compare/np-hiring-vs-aanp-jobcenter — thin route over the shared
 * comparison renderer. All content lives in lib/compare-data.ts (single
 * source, one review date); see app/compare/comparison-shared.tsx.
 */
...
const SLUG = 'np-hiring-vs-aanp-jobcenter';
...
export default function NpHiringVsAanpJobcenterPage() {
