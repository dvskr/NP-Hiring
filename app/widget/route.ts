...
<div class="pd-wrap">
  ...
  <div class="pd-footer">
    <span class="pd-stamp">
      Powered by <a href="${escape(brandUrl)}" target="_blank" rel="noopener">${brand.domain}</a>
    </span>
  </div>
</div>
</body>
...
<div class="pd-wrap">
  ...
  <div class="pd-footer">
    <span>Powered by <a href="${escape(brandUrl)}" target="_blank" rel="noopener">${brand.domain}</a></span>
  </div>
</div>
</body>
</html>`
...
function withWidgetHeaders(res: NextResponse): NextResponse {
  ...
  res.headers.set(
    ...
    `frame-ancestors 'self' https://*.edu ${brand.baseUrl}`,
  )
