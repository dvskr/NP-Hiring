...
async function getStats() {
  ...
  const medianSalaryK = await getGatedMedianKForWhere({ ...TV_FILTER, normalizedMinSalary: { not: null }, normalizedMaxSalary: { not: null } });
    ...
    <div style={{ backgroundColor: '#FDFBF7' }}>
      ...
      <CategoryHero
        ...
        stats={[
          ...
          { value: stats.medianSalaryK > 0 ? `$${stats.medianSalaryK}k` : '$60/hr+', label: 'median salary' },
        ...
        <section style={{ maxWidth: '1200px', margin: '0 auto', padding: '48px 20px 40px' }}>
          ...
          <div className="cat-bento-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(12, 1fr)', gap: '14px' }}>
            <div className="cat-bento-hero-1" style={{ ...clayCard, gridColumn: 'span 8', padding: '32px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px', alignItems: 'center' }}>
              ...
              <Image src="/images/categories/bento/travel-adventure.webp" alt={`Travel ${brand.niche.short} exploring new locations`} width={280} height={200} style={{ width: '100%', height: 'auto', borderRadius: '14px' }} />
            </div>
            <div className="cat-bento-hero-2" style={{ ...clayCard, gridColumn: 'span 4', padding: '28px', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
              <Image src="/images/categories/bento/travel-housing.webp" alt="Furnished housing provided" width={200} height={140} style={{ width: '100%', maxWidth: '180px', height: 'auto', borderRadius: '12px', marginBottom: '16px' }} />
            ...
            <div className="cat-bento-hero-3" style={{ ...clayCard, gridColumn: 'span 8', padding: '32px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px', alignItems: 'center' }}>
              ...
              <Image src="/images/categories/bento/travel-compensation.webp" alt={`Travel ${brand.niche.short} compensation`} width={280} height={200} style={{ width: '100%', height: 'auto', borderRadius: '14px' }} />
            </div>
