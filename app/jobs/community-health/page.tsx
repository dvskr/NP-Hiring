...
export default async function CommunityHealthJobsPage({ searchParams }: PageProps) {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#FDFBF7' }}>
      ...
      <JobListViewTracker jobs={jobs.map((j: Job) => ({ id: j.id, title: j.title, employer: j.employer }))} listName={`Community Health ${brand.niche.short} Jobs`} />
          ...
          <div className="lg:col-span-3">
            ...
            {jobs.length === 0 ? (
              <div className="text-center py-12 rounded-xl" style={{ backgroundColor: 'var(--bg-secondary)', border: '1px solid var(--border-color)' }}>
                ...
                <p className="mb-6" style={{ color: 'var(--text-secondary)' }}>New community health {brand.niche.short} openings are added daily.</p>
          ...
          <div className="lg:col-span-1">
            <div className="cat-bento-card" style={{ ...clayCard, padding: '0', overflow: 'hidden', marginBottom: '20px', background: 'linear-gradient(145deg, #FDF2F8, #FCE7F3)', border: '2px solid rgba(190,24,93,0.15)' }}>
              <div style={{ padding: '24px' }}>
                ...
                <p style={{ fontSize: '13px', color: '#BE185D', marginBottom: '16px', lineHeight: 1.6, fontWeight: 500 }}>New FQHC & community health listings daily.</p>
