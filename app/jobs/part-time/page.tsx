...
async function getStats() {
  ...
  const medianSalaryK = await getGatedMedianKForWhere({ ...PT_FILTER, normalizedMinSalary: { not: null }, normalizedMaxSalary: { not: null } });
...
const faqs = [
  { q: `How many hours do part-time ${brand.niche.short}s work?`, a: `Part-time ${brand.niche.short} roles typically involve 10 to 30 hours per week. Common schedules include 2 to 3 days per week, half-day clinics, or weekend-only coverage. PRN roles offer even more flexibility, with no minimum hour commitment.` },
  { q: `What do part-time ${brand.niche.short}s earn?`, a: `Part-time ${brand.niche.short} pay is usually hourly, roughly $45 to $75 per hour depending on specialty, setting, and region, in line with the typical $95K to $160K full-time band. PRN rates often run higher to compensate for the lack of benefits.` },
  { q: `Do part-time ${brand.niche.short}s get benefits?`, a: 'Benefits vary. Positions at 20+ hours per week often include prorated health insurance, PTO, and CME allowances. PRN roles typically pay higher hourly rates without benefits. Some employers offer a 401(k) plan to all staff regardless of hours.' },
  { q: 'Can I combine part-time roles?', a: `Yes. Many ${brand.niche.short}s combine 2 to 3 part-time positions across different settings (outpatient and telehealth, for example) to maximize income and flexibility. Confirm that non-compete clauses allow this, and maintain separate malpractice coverage.` },
  { q: 'Is part-time work a good option for new graduates?', a: 'Part-time work can suit new graduates who want gradual clinical exposure, but most employers prefer candidates who can commit to consistent schedules. Starting in a full-time role that offers mentorship may build skills faster.' },
];
...
export async function generateMetadata({ searchParams }: PageProps): Promise<Metadata> {
  ...
  return {
    title: `${stats.totalJobs} Part-Time ${brand.niche.short} Jobs: Flexible and PRN Roles`,
    description: `Find ${stats.totalJobs} part-time ${brand.niche.short} jobs. Flexible schedules, PRN positions, and genuine work-life balance across every specialty.`,
  ...
  return (
    <div style={{ backgroundColor: '#FDFBF7' }}>
      ...
      <CategoryHero
        ...
        breadcrumbs={crumbsFromSchema([{ name: "Home", url: brand.baseUrl }, { name: "Jobs", url: `${brand.baseUrl}/jobs` }, { name: "Part-Time", url: `${brand.baseUrl}/jobs/part-time` }])}
        ...
        stats={[
          ...
          { value: stats.medianSalaryK > 0 ? `$${stats.medianSalaryK}k` : '$45/hr+', label: 'median salary' },
      ...
      <div style={{ maxWidth: '1440px', margin: '0 auto', padding: '32px 24px' }}>
        <div className="grid lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div style={{ ...clayCard, padding: '24px', marginBottom: '20px', background: 'linear-gradient(145deg, #FDF2F8, #FCE7F3)', border: '2px solid rgba(190,24,93,0.15)' }}><Bell size={28} style={{ color: '#BE185D', marginBottom: '12px' }} /><h3 className="font-lora" style={{ fontSize: '18px', fontWeight: 700, color: '#831843', margin: '0 0 8px' }}>Part-Time Alerts</h3><p style={{ fontSize: '13px', color: '#BE185D', marginBottom: '16px' }}>New flexible positions posted daily.</p><Link href="/job-alerts" style={{ display: 'block', textAlign: 'center', padding: '10px 20px', borderRadius: '10px', fontWeight: 700, fontSize: '13px', background: '#BE185D', color: '#fff', textDecoration: 'none' }}>Create Alert</Link></div>
        ...
        <section style={{ maxWidth: '1200px', margin: '0 auto', padding: '48px 20px 40px' }}>
          ...
          <div className="cat-bento-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(12, 1fr)', gap: '14px' }}>
            <div className="cat-bento-hero-1" style={{ ...clayCard, gridColumn: 'span 8', padding: '32px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px', alignItems: 'center' }}>
              <div><h3 className="font-lora" style={{ fontSize: '20px', fontWeight: 700, color: '#1A2E35', margin: '0 0 10px' }}>Flexible Scheduling</h3><p style={{ fontSize: '14px', color: '#5A4A42', lineHeight: 1.7, margin: 0 }}>Choose schedules of 2 to 3 days per week, half-day clinics, or weekend-only coverage. Design your work week around your priorities.</p></div>
              <Image src="/images/categories/bento/part-time-flex.webp" alt="Flexible schedule" width={280} height={200} style={{ width: '100%', height: 'auto', borderRadius: '14px' }} />
            </div>
            <div className="cat-bento-hero-2" style={{ ...clayCard, gridColumn: 'span 4', padding: '28px', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
              <Image src="/images/categories/bento/part-time-balance.webp" alt="Work-life balance" width={200} height={140} style={{ width: '100%', maxWidth: '180px', height: 'auto', borderRadius: '12px', marginBottom: '16px' }} />
            ...
            <div className="cat-bento-hero-3" style={{ ...clayCard, gridColumn: 'span 8', padding: '32px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px', alignItems: 'center' }}>
              <div><TrendingUp size={28} style={{ color: '#34D399', marginBottom: '12px' }} /><h3 className="font-lora" style={{ fontSize: '20px', fontWeight: 700, color: '#1A2E35', margin: '0 0 10px' }}>Part-Time Pay</h3><p style={{ fontSize: '14px', color: '#5A4A42', lineHeight: 1.7, margin: '0 0 6px' }}>Median part-time {brand.niche.short} salary:</p><p style={{ fontSize: '32px', fontWeight: 800, color: '#1A2E35', margin: 0 }}>${stats.medianSalaryK}k</p></div>
              <Image src="/images/categories/bento/part-time-salary.webp" alt="Part-time pay" width={280} height={200} style={{ width: '100%', height: 'auto', borderRadius: '14px' }} />
            </div>
            <div className="cat-bento-cta" style={{ ...clayCard, gridColumn: 'span 4', padding: '28px', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', textAlign: 'center', background: 'linear-gradient(145deg, #FDF2F8, #FCE7F3)' }}>
              <Bell size={32} style={{ color: '#BE185D', marginBottom: '14px' }} /><h3 className="font-lora" style={{ fontSize: '18px', fontWeight: 700, color: '#831843', margin: '0 0 10px' }}>Get Part-Time Alerts</h3><p style={{ fontSize: '13px', color: '#BE185D', lineHeight: 1.6, margin: '0 0 20px' }}>New flexible positions daily.</p>
