...
async function getStats() {
  ...
  const medianSalaryK = await getGatedMedianKForWhere({ ...HO_FILTER, normalizedMinSalary: { not: null }, normalizedMaxSalary: { not: null } });
...
const faqs = [
  ...
  { q: `What salary do hospital ${brand.niche.short}s earn?`, a: `Hospital ${brand.niche.short}s typically earn toward the upper end of the $95K to $160K ${brand.niche.short} range, with shift differentials for nights and weekends, sign-on bonuses, and comprehensive benefits. Academic medical centers and urban hospitals often pay at the higher end.` },
  { q: `What schedule do hospital ${brand.niche.short}s work?`, a: 'Most hospital roles use 7-on/7-off, 3x12-hour shifts, or rotating day/night schedules. Some hospital-based clinics and procedural services offer traditional Monday to Friday hours.' },
  { q: 'What qualifications are required?', a: `Requirements include an active APRN license, national ${brand.niche.short} certification, DEA registration, BLS/ACLS, and typically 1+ years of acute care experience. New graduates may find opportunities in hospital ${brand.niche.short} residency and fellowship programs.` },
  { q: 'Do hospital systems offer loan forgiveness?', a: 'Yes. Many hospital systems qualify as 501(c)(3) nonprofits eligible for Public Service Loan Forgiveness (PSLF). After 120 qualifying payments, the remaining federal student loan balance is forgiven.' },
];
      ...
      <div style={{ maxWidth: '1440px', margin: '0 auto', padding: '32px 24px' }}>
        <div className="grid lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div style={{ ...clayCard, padding: '24px', marginBottom: '20px', background: 'linear-gradient(145deg, #FDF2F8, #FCE7F3)', border: '2px solid rgba(190,24,93,0.15)' }}><Bell size={28} style={{ color: '#BE185D', marginBottom: '12px' }} /><h3 className="font-lora" style={{ fontSize: '18px', fontWeight: 700, color: '#831843', margin: '0 0 8px' }}>Hospital Alerts</h3><p style={{ fontSize: '13px', color: '#BE185D', marginBottom: '16px' }}>New hospital positions are posted daily.</p><Link href="/job-alerts" style={{ display: 'block', textAlign: 'center', padding: '10px 20px', borderRadius: '10px', fontWeight: 700, fontSize: '13px', background: '#BE185D', color: '#fff', textDecoration: 'none' }}>Create Alert</Link></div>
        ...
        <section style={{ maxWidth: '1200px', margin: '0 auto', padding: '48px 20px 40px' }}>
          ...
          <div className="cat-bento-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(12, 1fr)', gap: '14px' }}>
            ...
            <div className="cat-bento-cta" style={{ ...clayCard, gridColumn: 'span 4', padding: '28px', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', textAlign: 'center', background: 'linear-gradient(145deg, #FDF2F8, #FCE7F3)' }}>
              <Bell size={32} style={{ color: '#BE185D', marginBottom: '14px' }} /><h3 className="font-lora" style={{ fontSize: '18px', fontWeight: 700, color: '#831843', margin: '0 0 10px' }}>Get Hospital Alerts</h3><p style={{ fontSize: '13px', color: '#BE185D', lineHeight: 1.6, margin: '0 0 20px' }}>New acute care positions are posted daily.</p>
      ...
      <div style={{ background: 'linear-gradient(180deg, #FDF2F8 0%, #FDF2F8 50%, #FDF2F8 100%)' }}>
        <section style={{ maxWidth: '1200px', margin: '0 auto', padding: '56px 20px' }}>
          ...
          <div className="cat-explore-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '14px' }}>
            {[{ href: '/jobs/inpatient', label: 'Inpatient', sub: 'Hospital units' }, { href: '/jobs/outpatient', label: 'Outpatient', sub: 'Clinic-based', icon: '/images/categories/nav/outpatient.webp' }, { href: '/jobs/emergency', label: 'Emergency', sub: 'ED & urgent care' }, { href: '/jobs/geriatric', label: 'Geriatric', sub: 'Elder care' }, { href: '/salary-guide', label: 'Salary Guide', sub: '2026 data', icon: '/images/categories/nav/salary.webp' }, { href: '/jobs/locations', label: 'By Location', sub: '50 states', icon: '/images/categories/nav/location.webp' }].map(c => (
