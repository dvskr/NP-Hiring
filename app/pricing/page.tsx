...
export const metadata: Metadata = {
    ...
    openGraph: {
        ...
        images: [{ url: 'https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/pages/pmhnp-employer-hiring-solutions.webp', width: 1280, height: 900, alt: 'NP job board pricing' }],
    },
