...
export const metadata: Metadata = {
  ...
  description: 'Compare 1099 independent contractor vs W2 employee NP compensation. Tax strategies, benefits comparison, income calculator, and which model maximizes your nurse practitioner earnings.',
  keywords: ['1099 vs W2 NP', '1099 nurse practitioner', 'NP independent contractor taxes', 'contractor vs employee NP', '1099 NP telehealth pay', 'NP compensation comparison'],
  openGraph: {
    title: '1099 vs W2 for NPs — Compensation Guide',
    description: 'Which pays more? Complete comparison of independent contractor vs employee compensation for nurse practitioners.',
    type: 'article',
    images: [{ url: HERO_IMAGE, width: 1280, height: 900, alt: '1099 vs W2 NP Compensation Guide' }],
  },
  twitter: {
...
export default function CompensationGuidePage() {
  const compFaqs = [
    {
      question: "Is 1099 or W2 better for NPs?",
      answer: "It depends on your priorities. 1099 offers higher gross pay ($75-$150+/hr), schedule flexibility, and tax deductions but requires self-management of taxes, insurance, and retirement. W2 offers stability, employer benefits (health, 401k, PTO, malpractice), and simpler taxes. Most NPs who value income maximization prefer 1099 after gaining 2-3 years of experience."
    },
    {
      question: "How much more do 1099 NPs make than W2?",
      answer: "1099 NPs earn 20-40% higher GROSS hourly rates than W2 ($75-$150/hr vs $55-$100/hr). However, after accounting for self-employment tax (15.3%), individual health insurance ($6K-$18K/year), malpractice ($1.5-3K/year), and no employer 401k match, the NET take-home difference is typically 10-20% higher for 1099 — IF you manage expenses and deductions well."
    },
    {
      question: "What tax deductions can 1099 NPs claim?",
    ...
    {
      question: "Should new grad NPs take 1099 positions?",
      answer: "Generally, no. New grads benefit from W2 positions that offer mentorship, structured onboarding, employer-paid malpractice, and benefits. 1099 work requires clinical confidence and business management skills. Most NPs transition to 1099 after 2-3 years when they can command higher rates and handle the business aspects independently."
    },
    {
      question: "Can you do both 1099 and W2 as a NP?",
      answer: "Yes, many NPs work a W2 job for stability and benefits while taking 1099 side contracts for extra income. This 'hybrid' approach gives you employer benefits while earning premium 1099 rates for additional hours. Check your W2 employment contract for non-compete clauses or moonlighting restrictions."
    },
    {
      question: "What retirement accounts should 1099 NPs use?",
      answer: "1099 NPs have access to powerful retirement options: SEP-IRA (contribute up to 25% of net earnings, max $66,000/year in 2024), Solo 401k ($23,000 employee + 25% employer contributions = up to $69,000 total), or Traditional/Roth IRA ($7,000/year). The Solo 401k offers the most flexibility with both employee and employer contribution tiers."
    },
  ];
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            '@context': 'https://schema.org',
            '@type': 'Article',
            headline: '1099 vs W2 for NPs — Complete Compensation Comparison 2026',
            description: 'Compare independent contractor vs employee compensation for nurse practitioners.',
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mb-8 md:mb-12 grid md:grid-cols-2 gap-6">
            <div className="rounded-xl p-6" style={{ backgroundColor: 'var(--bg-secondary)', border: '2px solid #0d9488' }}>
              ...
              <p className="mt-4 text-xs font-medium" style={{ color: 'var(--color-primary)' }}>Best for: Experienced NPs who want maximum control and income</p>
            </div>
            <div className="rounded-xl p-6" style={{ backgroundColor: 'var(--bg-secondary)', border: '2px solid #6366f1' }}>
              ...
              <p className="mt-4 text-xs font-medium text-indigo-600">Best for: New grads, NPs wanting stability and mentorship</p>
            </div>
          </div>
          ...
          <div className="mb-8 md:mb-12">
            <div className="rounded-xl p-6 md:p-8" style={{ backgroundColor: 'var(--bg-secondary)', border: '1px solid var(--border-color)' }}>
              ...
              <p className="text-sm mb-4" style={{ color: 'var(--text-secondary)' }}>
                Real-world comparison of a typical NP earning $160K W2 vs $200K gross as a 1099 contractor:
              </p>
          ...
          <div className="mb-8 md:mb-12">
            <div className="rounded-xl p-6 md:p-8" style={{ backgroundColor: 'var(--bg-secondary)', border: '1px solid var(--border-color)' }}>
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-2xl font-bold" style={{ color: 'var(--text-primary)' }}>Tax Optimization for 1099 NPs</h2>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            <Link href="/jobs/1099" className="block p-4 rounded-lg hover:shadow-sm transition-all" style={{ backgroundColor: 'var(--bg-secondary)', border: '1px solid var(--border-color)' }}>
              <h3 className="font-semibold" style={{ color: 'var(--color-primary)' }}>📋 Browse 1099 NP Jobs</h3>
            ...
            <Link href="/resources/private-practice-guide" className="block p-4 rounded-lg hover:shadow-sm transition-all" style={{ backgroundColor: 'var(--bg-secondary)', border: '1px solid var(--border-color)' }}>
              ...
              <p className="text-sm mt-1" style={{ color: 'var(--text-secondary)' }}>Start your own NP practice step by step.</p>
            </Link>
