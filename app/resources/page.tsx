  ...
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        hasPart: [
          { '@type': 'Article', name: 'PMHNP Full Practice Authority Guide', url: `${brand.baseUrl}/resources/fpa-guide` },
          { '@type': 'Article', name: '1099 vs W2 for PMHNPs — Compensation Comparison', url: `${brand.baseUrl}/resources/1099-vs-w2` },
          { '@type': 'Article', name: 'How to Start a PMHNP Private Practice', url: `${brand.baseUrl}/resources/private-practice-guide` },
        ],
        numberOfItems: 3,
      }) }} />
