...
const SALARY_GUIDE_URL = process.env.SALARY_GUIDE_URL || 'https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/resources/NP_Salary_Guide_2026.pdf';
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/pages/pmhnp-career-resources-guides.webp', width: 1280, height: 900, alt: 'NP career resources and guides' }],
  },
  twitter: { card: 'summary_large_image', images: ['https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/pages/pmhnp-career-resources-guides.webp'] },
...
const CATEGORY_CONFIG: Record<string, { label: string; color: string; bg: string; icon: string }> = {
  career_opportunities: { label: 'Career', color: '#6366F1', bg: '#EEF2FF', icon: 'https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/employers/clay-trending.webp' },
  salary_negotiation: { label: 'Salary', color: '#0D9488', bg: '#F0FDFA', icon: 'https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/employers/clay-dollar.webp' },
  job_seeker_attraction: { label: 'Job Search', color: '#3B82F6', bg: '#EFF6FF', icon: 'https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/blog/icon-job-search.webp' },
  career_myths: { label: 'Education', color: '#A855F7', bg: '#FAF5FF', icon: 'https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/blog/icon-education.webp' },
  community_lifestyle: { label: 'Lifestyle', color: '#F59E0B', bg: '#FFFBEB', icon: 'https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/employers/clay-people.webp' },
  employer_facing: { label: 'Employers', color: '#EF4444', bg: '#FEF2F2', icon: 'https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/blog/icon-employers.webp' },
  product_lead_gen: { label: 'Product', color: '#0D9488', bg: '#F0FDFA', icon: 'https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/blog/icon-product.webp' },
  industry_awareness: { label: 'Industry', color: '#8B5CF6', bg: '#F5F3FF', icon: 'https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/blog/icon-industry.webp' },
};
...
const featuredGuides = [
  {
    ...
    img: 'https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/employers/clay-dollar.webp',
  ...
  },
  {
    ...
    img: 'https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/employers/clay-chart.webp',
    badge: '50 States',
    badgeColor: '#6366F1',
  },
  {
    ...
    img: 'https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/employers/clay-trending.webp',
    badge: 'Step-by-Step',
    badgeColor: '#F59E0B',
  },
];
          ...
          <div style={{ textAlign: 'left' }}>
            ...
            <Link href="/resources/1099-vs-w2" className="emp-bento-card" style={{
              ...
              <div style={{ padding: '24px 28px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                <Image src="https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/employers/clay-dollar.webp" alt="1099 vs W2" width={56} height={56} style={{ width: '56px', height: '56px', borderRadius: '16px' }} />
              </div>
            </Link>
          </div>
        </section>
      ...
      <div style={{ background: 'linear-gradient(180deg, #FFF5EE 0%, #FDE8D8 50%, #FFF5EE 100%)', padding: '80px 20px' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          ...
          {Object.entries(grouped).map(([category, posts]) => {
            const cfg = CATEGORY_CONFIG[category] || { label: category, color: '#64748B', bg: '#F1F5F9', icon: 'https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/employers/clay-star.webp' };
            return (
        ...
        <div style={{ maxWidth: '900px', margin: '0 auto' }}>
          ...
          <div className="res-tools-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '14px' }}>
            ...
            <Link href="/salary-guide" className="emp-bento-card" style={{
              ...
              <Image src="https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/employers/clay-dollar.webp" alt="Salary Calculator" width={48} height={48} style={{ width: '48px', height: '48px', borderRadius: '14px', marginBottom: '12px' }} />
            ...
            <div className="emp-bento-card" style={{ ...clayCard, padding: '28px 24px' }}>
              <Image src="https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/employers/clay-envelope.webp" alt="PDF Guide" width={48} height={48} style={{ width: '48px', height: '48px', borderRadius: '14px', marginBottom: '12px' }} />
        ...
        <div style={{ maxWidth: '700px', margin: '0 auto' }}>
          <div className="emp-bento-card" style={{
            ...
            <div style={{ background: 'linear-gradient(145deg, #0D9488, #10B981)', padding: '40px 32px', color: '#fff' }}>
              <Image src="https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/clay-icon-match.webp" alt="Jobs" width={56} height={56} style={{ width: '56px', height: '56px', margin: '0 auto 16px', borderRadius: '16px' }} />
