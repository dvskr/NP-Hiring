...
export default function PdCampaignClient({ leads, funnel, total }: Props) {
  ...
  function confirmInstall(id: string, formData: FormData) {
    ...
    if (!url) {
      setError('A career-services URL is required to mark this lead as installed.')
      return
    }
    ...
    <div style={{ padding: '32px 24px', maxWidth: '1280px', margin: '0 auto' }}>
      <header style={{ marginBottom: '24px' }}>
        ...
        <p style={{ margin: 0, color: '#64748B', fontSize: '14px' }}>
          ...
          The send script handles `wave1_sent` and `wave2_sent` automatically. Use
          this page for everything downstream of that step.
        </p>
      </header>
