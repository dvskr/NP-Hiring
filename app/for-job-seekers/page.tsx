...
export const metadata: Metadata = {
  ...
  openGraph: {
    images: [{ url: 'https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/pages/pmhnp-job-seeker-career-resources.webp', width: 1280, height: 900, alt: 'NP job seeker career resources' }],
  },
  twitter: { card: 'summary_large_image', images: ['https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/pages/pmhnp-job-seeker-career-resources.webp'] },
  ...
  return (
    <>
      <BreadcrumbSchema items={[
        ...
        { name: 'For Job Seekers', url: 'https://nphiring.com/for-job-seekers' },
      ]} />
          ...
          <div className="seeker-bento" style={{
            ...
            <div className="seeker-bento-hero-1 emp-bento-card" style={{
              ...
              <div style={{ padding: '32px 28px' }}>
                <Image src="https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/job-seekers/icon-ai-match.webp" alt="" width={56} height={56} style={{ width: '56px', height: '56px', objectFit: 'contain', marginBottom: '16px' }} />
              ...
              <div style={{ height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(145deg, #F0FDFA, #CCFBF1)', padding: '16px' }}>
                <Image src="https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/job-seekers/bento-match.webp" alt="AI match scoring" width={280} height={200} style={{ width: '100%', maxWidth: '280px', height: 'auto', borderRadius: '12px' }} />
              </div>
            </div>
            ...
            <div className="seeker-bento-hero-2 emp-bento-card" style={{
              ...
              <div style={{ flex: '0 0 auto', background: 'linear-gradient(145deg, #F0FDFA, #CCFBF1)', padding: '16px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <Image src="https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/job-seekers/bento-salary.webp" alt="Salary transparency" width={200} height={140} style={{ width: '100%', maxWidth: '200px', height: 'auto', borderRadius: '10px' }} />
              </div>
              <div style={{ padding: '24px 22px', flex: 1 }}>
                <Image src="https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/job-seekers/icon-salary.webp" alt="" width={48} height={48} style={{ width: '48px', height: '48px', objectFit: 'contain', marginBottom: '12px' }} />
            ...
            <div className="emp-bento-card" style={{ ...clayCard, gridColumn: 'span 3', padding: '24px 18px', textAlign: 'center' }}>
              <Image src="https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/job-seekers/icon-alerts.webp" alt="" width={48} height={48} style={{ width: '48px', height: '48px', objectFit: 'contain', margin: '0 auto 14px', display: 'block' }} />
            ...
            <div className="emp-bento-card" style={{ ...clayCard, gridColumn: 'span 3', padding: '24px 18px', textAlign: 'center' }}>
              <Image src="https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/job-seekers/icon-tracking.webp" alt="" width={48} height={48} style={{ width: '48px', height: '48px', objectFit: 'contain', margin: '0 auto 14px', display: 'block' }} />
            ...
            <div className="emp-bento-card" style={{ ...clayCard, gridColumn: 'span 3', padding: '24px 18px', textAlign: 'center' }}>
              <Image src="https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/job-seekers/icon-resume.webp" alt="" width={48} height={48} style={{ width: '48px', height: '48px', objectFit: 'contain', margin: '0 auto 14px', display: 'block' }} />
            ...
            <div className="emp-bento-card" style={{ ...clayCard, gridColumn: 'span 3', padding: '24px 18px', textAlign: 'center' }}>
              <Image src="https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/job-seekers/icon-save.webp" alt="" width={48} height={48} style={{ width: '48px', height: '48px', objectFit: 'contain', margin: '0 auto 14px', display: 'block' }} />
            ...
            <div className="seeker-bento-hero-3 emp-bento-card" style={{
              ...
              <div style={{ padding: '32px 28px' }}>
                <Image src="https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/job-seekers/icon-licensure.webp" alt="" width={56} height={56} style={{ width: '56px', height: '56px', objectFit: 'contain', marginBottom: '16px' }} />
              ...
              <div style={{ height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(145deg, #FFF7ED, #FFEDD5)', padding: '16px' }}>
                <Image src="https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/job-seekers/bento-guides.webp" alt="50-state licensure guides" width={280} height={200} style={{ width: '100%', maxWidth: '280px', height: 'auto', borderRadius: '12px' }} />
              </div>
            </div>
            ...
            <div className="seeker-bento-free emp-bento-card" style={{
              ...
              <Image src="https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/job-seekers/icon-free.webp" alt="" width={48} height={48} style={{ width: '48px', height: '48px', objectFit: 'contain', marginBottom: '14px' }} />
      ...
      <section style={{ background: 'linear-gradient(180deg, #FDE8D8 0%, #F5D0B5 40%, #FDE8D8 100%)', padding: '80px 20px' }}>
        <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
          ...
          <div className="seeker-types-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '16px' }}>
            {[
              { title: 'Remote / Telehealth', desc: 'Work from anywhere — virtual primary care, telehealth, telepsychiatry', href: '/jobs?mode=Remote', img: '' },
              { title: 'In-Person Clinical', desc: 'Hospital, clinic, and outpatient roles', href: '/jobs?mode=In-Person', img: '' },
              { title: 'Private Practice', desc: 'Start or join an independent NP practice', href: '/resources/private-practice-guide', img: '' },
              { title: 'Part-Time / PRN', desc: 'Flexible schedules and per diem', href: '/jobs?jobType=Part-Time', img: '' },
            ].map(t => (
          ...
          <div className="seeker-compare-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 320px', gap: '24px', alignItems: 'start' }}>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <Image
                  src="https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/job-seekers/cta-dream-role.webp"
            ...
            {[
              {
                ...
                href: '/salary-guide',
                icon: 'https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/job-seekers/icon-salary.webp',
              ...
              },
              {
                ...
                href: '/resources',
                icon: 'https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/job-seekers/icon-licensure.webp',
              ...
              },
              {
                ...
                href: '/blog',
                icon: 'https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/job-seekers/icon-blog.webp',
              ...
              },
              {
                ...
                icon: 'https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/job-seekers/icon-fpa.webp',
