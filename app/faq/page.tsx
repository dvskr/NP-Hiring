...
const FAQ_OG_IMAGE = 'https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/pages/pmhnp-hiring-frequently-asked-questions.webp';

export const metadata: Metadata = {
  // `absolute` opts out of the layout title template so we don't end up
  // with "FAQ | NP Jobs | NP Hiring" (the brand-confusing form
  // audit 09 M-18 flagged — "NP Jobs" is not the brand name).
  title: { absolute: 'NP Hiring FAQ — Job Search, Posting & Alerts' },
  description: 'Frequently asked questions about NP Hiring. Learn how to search jobs, post positions, set up alerts, and make the most of the #1 NP job board.',
  openGraph: {
    title: 'NP Hiring FAQ',
    description: 'Common questions about searching, posting, and managing NP jobs.',
    type: 'website',
...
export default function FAQPage() {
  const jobSeekerFaqs = [
    {
      question: "Is NP Jobs free to use?",
    ...
    },
    {
      ...
      answer: "We aggregate jobs from multiple sources including job boards, company career pages, and direct employer postings. This gives you access to the most comprehensive collection of NP opportunities in one place."
    },
    {
  ...
  const careerFaqs = [
    {
      ...
      answer: "Becoming a NP typically takes 6-8 years: 4 years for a BSN, 1-2 years of RN experience, and 2-3 years for an MSN or DNP with NP specialization. Accelerated BSN-to-DNP programs can shorten this timeline."
    },
    {
      question: "What educational background is required for a NP role?",
      answer: "You need a Bachelor of Science in Nursing (BSN), then a Master's (MSN) or Doctoral (DNP) degree with psychiatric-mental health specialization from a CCNE or ACEN accredited program. You must also pass the ANCC APRN-BC certification exam."
    },
    {
      question: "What is the difference between a NP and a psychiatrist?",
      answer: "NPs hold a Master's or Doctoral degree in nursing (2-4 years of graduate school), while psychiatrists complete medical school plus a 4-year residency. Both can diagnose and prescribe. In full practice authority states, NPs practice independently. NPs earn $155,000-$200,000+ vs psychiatrists' $250,000-$350,000+."
    },
    {
      question: "What is the difference between a NP and an FNP?",
      answer: "A NP (Psychiatric Mental Health NP) specializes in diagnosing and treating mental health conditions across the lifespan, including prescribing psychotropic medications. An FNP (Family NP) provides primary care for all ages. NPs focus on psychiatric disorders, psychotherapy, and psychopharmacology, while FNPs handle general medical conditions."
    },
    {
      question: "Can I complete a NP program online?",
      answer: "Yes, many accredited universities offer online NP programs. Didactic coursework is completed online, but you'll still need to complete 500+ clinical hours in person at approved sites. Top online programs include Vanderbilt, Rush, and University of Cincinnati."
    },
    {
      question: "What is the ROI of a NP degree?",
      answer: "The ROI is excellent. Graduate school costs $35,000-$80,000 for an MSN. NPs earn an average of $155,000+ — roughly $75,000 more per year than an RN. Most NPs pay off their graduate degree investment within 2-3 years of working."
    },
    {
      question: "What are the top 3 NP jobs for new grads?",
      answer: "1) Community Mental Health Centers — structured settings with mentorship, often qualifying for HRSA loan repayment. 2) Outpatient group practices — collaborative environments with gradual caseload ramp-up. 3) VA nurse practitioner positions — federal benefits, pension, and residency programs for new graduates."
    },
  ];

  const salaryFaqs = [
    {
      question: "What is the average salary of a nurse practitioner in the United States?",
      answer: "The average NP salary in 2026 is $155,000-$165,000 per year. New graduates start at $115,000-$145,000, while experienced NPs (7-15 years) earn $180,000-$210,000. Private practice owners can earn $200,000-$300,000+. The top 10% earn over $210,000 annually."
    },
    {
      question: "Which states pay the highest salaries for NPs?",
      answer: "The highest-paying states for NPs include Idaho ($205,080 average), New Jersey ($182,022), California ($181,670), Rhode Island ($175,530), and Washington ($173,331). When adjusted for cost of living, Idaho, Louisiana, Pennsylvania, Arkansas, and Missouri offer the best value."
    },
    {
      question: "How do nurse practitioner salaries compare to other NP roles?",
      answer: "NPs are among the highest-paid NP specialties. They earn 10-20% more than Family NPs (average $120,000-$135,000) and comparable to Acute Care NPs. This premium reflects the critical shortage of mental health providers and the specialized nature of psychiatric care."
    },
    {
      question: "Does having a DNP vs MSN affect a NP's salary?",
      answer: "In clinical roles, DNP and MSN NPs typically earn similar salaries — the degree itself rarely commands a higher clinical wage. However, DNP holders have advantages in academic positions, executive leadership roles, and may qualify for higher-tier positions in hospital systems."
    },
    {
      question: "How can you make the most money as a NP?",
    ...
    {
      question: "What is the salary range for locum tenens NP jobs?",
      answer: "Locum tenens NPs earn $150,000-$250,000+ annually, with hourly rates of $85-$150+. This includes housing stipends, travel allowances, and malpractice coverage. Locum tenens pay rates are typically 20-50% higher than permanent positions, making it one of the highest-earning NP career paths."
    },
  ];

  const scopeFaqs = [
    {
      question: "What is the scope of practice for a NP?",
      answer: "A NP's scope of practice includes conducting psychiatric evaluations, diagnosing mental health disorders (using DSM-5-TR criteria), prescribing psychotropic medications including controlled substances, providing psychotherapy (CBT, DBT, motivational interviewing), ordering and interpreting diagnostic tests, and managing treatment plans. The specific scope varies by state practice authority laws."
    },
    {
      question: "What are the certification requirements for NP graduates?",
      answer: "After graduating from an accredited NP program, you must pass the ANCC APRN-BC exam ($395), apply for state APRN licensure, obtain an NPI number, register with the DEA for prescriptive authority ($888/3 years), and create a CAQH ProView profile for insurance credentialing. Board certification must be renewed every 5 years with 75 CE hours."
    },
    {
      question: "What extra certifications can a NP get?",
      answer: "NPs can pursue additional credentials including MAT/DATA waiver for addiction treatment, child and adolescent psychiatry specialization, addiction nursing certification (CARN-AP), forensic nursing certification, and geriatric psychiatry specialization. These certifications command 10-25% salary premiums."
    },
    {
      question: "Are there state licensure rules that affect demand for NPs?",
      answer: "Yes. States with Full Practice Authority (34 states + DC) allow NPs to practice independently, driving higher demand and salaries. Reduced and restricted practice states require physician collaboration or supervision, which can limit the number of available positions and affect compensation."
    },
    {
      question: "What skills are employers seeking in NP graduates?",
    ...
    {
      question: "What negotiation strategies can enhance salary offers for NPs?",
      answer: "Key strategies include researching market rates by state and setting, negotiating total compensation (not just base salary), asking for sign-on bonuses ($5,000-$30,000), requesting CME allowance ($2,000-$5,000/year), student loan repayment assistance, additional PTO, and flexible scheduling. NPs who negotiate typically secure 5-15% higher starting salaries."
    },
  ];
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1fr) 280px', gap: '32px', alignItems: 'center' }} className="faq-hero-grid">
              <div>
                  ...
                  <p style={{ fontSize: '20px', color: '#6B7F8A', lineHeight: 1.6, margin: 0, maxWidth: '500px' }}>
                      Find answers to common questions about NP Jobs, platform features, salary benchmarks, and clinical credentials.
                  </p>
              </div>
              <div style={{ display: 'flex', justifyContent: 'center' }}>
                  <Image src="https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/pages/clay_hero_faq.webp" alt="FAQ NP Jobs" width={280} height={280} style={{ objectFit: 'contain', filter: 'drop-shadow(0 20px 30px rgba(0,0,0,0.15))' }} priority />
              </div>
          </div>
      </section>
