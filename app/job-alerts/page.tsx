...
function JobAlertsContent() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#FBEFE4' }}>
      ...
      <CategoryHero
        bgColor="#0D9488"
        heroImage="https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/categories/hero_wc_alerts.webp"
        heroAlt="Job Alerts"
        ...
        description="Get personalized NP job alerts delivered straight to your inbox. Be the first to apply to jobs that match your exact criteria."
