...
export const metadata: Metadata = {
  ...
  openGraph: {
    images: [{ url: 'https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/pages/pmhnp-hiring-privacy-policy.webp', width: 1280, height: 900, alt: `${brand.name} privacy policy page detailing data collection, security measures, and user privacy rights` }],
  },
  twitter: { card: 'summary_large_image', images: ['https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/pages/pmhnp-hiring-privacy-policy.webp'] },
        ...
        <header style={{ marginBottom: '40px', paddingBottom: '32px', borderBottom: '1px solid rgba(0,0,0,0.06)' }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1fr) 140px', gap: '24px', alignItems: 'center' }} className="legal-hero-grid">
            ...
            <div style={{ display: 'flex', justifyContent: 'center' }}>
              <Image src="https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/pages/clay_hero_privacy.webp" alt="Privacy Policy" width={140} height={140} style={{ objectFit: 'contain', filter: 'drop-shadow(0 12px 20px rgba(0,0,0,0.12))' }} priority />
            </div>
          </div>
        </header>
