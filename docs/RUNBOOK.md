...
| [runbooks/template-conversion-2026-05.md](runbooks/template-conversion-2026-05.md) | Runbook | You want to turn this codebase into a reusable template that powers 2+ job boards across different niches |
...
| "How do I fork this repo for a new niche?" (one-off, OK with divergence) | [fork-checklist.md](fork-checklist.md) |
| "How do I turn this into a real template for 2+ boards?" | [runbooks/template-conversion-2026-05.md](runbooks/template-conversion-2026-05.md) |
