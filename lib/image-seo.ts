...
export interface PageImageSEO {
    /** Path to WebP image relative to public, e.g. https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/pages/pmhnp-job-board-homepage.webp */
    image: string;
...
const BASE = 'https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/pages';
