...
const CATEGORY_FAQS: Partial<Record<CategorySlug, (props: CategoryFaqInput) => FAQItem[]>> = {
    ...
    'substance-abuse': ({ totalJobs }) => [
        {
            question: `How many substance abuse ${brand.niche.short} positions are available?`,
            answer: `There are currently ${totalJobs} substance abuse and addiction ${brand.niche.short} positions available. These include MAT clinics, residential rehab facilities, detox centers, and dual-diagnosis treatment programs.`,
        },
        {
            question: `Do ${brand.niche.short}s need special training for addiction treatment?`,
            answer: `While ${brand.niche.short}s can prescribe buprenorphine (Suboxone) with their standard DEA registration, additional training in addiction medicine is highly recommended. ASAM certification, motivational interviewing training, and CE courses in substance use disorders enhance clinical effectiveness and marketability.`,
        },
        {
            question: `What does a substance abuse ${brand.niche.short} do daily?`,
            answer: `Addiction ${brand.niche.short}s manage MAT programs (buprenorphine, naltrexone), conduct substance use assessments, monitor urine drug screens, coordinate with therapists and counselors, manage ${brand.niche.adjective} comorbidities, and develop relapse prevention plans. Many also provide group therapy facilitation.`,
        },
        {
            question: `Is there loan repayment for addiction ${brand.niche.short} positions?`,
    ...
    'child-adolescent': ({ totalJobs }) => [
        {
            question: `How many child & adolescent ${brand.niche.short} jobs are available?`,
            answer: `There are currently ${totalJobs} child and adolescent ${brand.niche.short} positions available. These span children's hospitals, school-based health centers, pediatric clinics, residential treatment facilities, and community ${brand.niche.category} agencies.`,
        },
        {
            question: `Do ${brand.niche.short}s need special certification for pediatric psychiatry?`,
            answer: `The standard ${brand.niche.short} certification (ANCC) is across-the-lifespan and qualifies you to treat children. However, employers strongly prefer candidates with pediatric clinical experience. Some programs offer child/adolescent ${brand.niche.short} concentrations, and post-graduate fellowships provide specialized training.`,
        },
        {
            question: `What conditions do child & adolescent ${brand.niche.short}s treat?`,
    ...
    'behavioral-health': ({ totalJobs, avgSalary }) => [
        {
            ...
            answer: `There are currently ${totalJobs} behavioral health nurse practitioner positions available. These span outpatient clinics, inpatient units, community ${brand.niche.category} centers, telehealth platforms, and integrated care settings.`,
        },
        {
        ...
        },
        {
            ...
            answer: `Behavioral health NPs work in diverse settings including outpatient ${brand.niche.category} clinics, hospitals (inpatient psychiatry), community ${brand.niche.category} centers (CMHCs), FQHCs, telehealth platforms, residential treatment facilities, correctional facilities, VA medical centers, schools, and private practice.`,
        },
        {
