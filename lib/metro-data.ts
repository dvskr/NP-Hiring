...
export const METRO_CITIES: MetroCity[] = [
  ...
  },
  {
    ...
    licensureNote: 'Florida NPs practice under a supervisory protocol with a physician, and a 2020 state law allows NPs with 3,000+ supervised hours in the past 5 years to register for autonomous practice in primary care. The Florida Board of Nursing typically processes licenses in 4 to 6 weeks.',
  ...
  },
  {
    ...
    whyThisMetro: [
      ...
      'Full Practice Authority, with independent practice and prescribing from day one',
    ],
