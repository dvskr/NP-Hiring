...
const VBASE = '/videos';
const IBASE = 'https://ytpmrlpnpbdylujbtgij.supabase.co/storage/v1/object/public/site-assets/images/pages';
...
export const PAGE_VIDEO_SEO: Record<string, PageVideoSEO> = {
    '/': {
        ...
        description: 'Scroll through the NP Hiring homepage — browse 10,000+ psychiatric nurse practitioner jobs from 3,000+ companies across all 50 states with salary transparency.',
        duration: 20,
    ...
    '/about': {
        ...
        title: 'About NP Hiring Platform',
        description: 'Learn about NP Hiring — our mission, data methodology, and how we aggregate psychiatric mental health nurse practitioner jobs from thousands of sources.',
        duration: 20,
        uploadDate: UPLOAD_DATE,
    },
    '/for-employers': {
        ...
        description: 'See how employers can post PMHNP jobs, access targeted recruitment, and connect with qualified psychiatric nurse practitioners on NP Hiring.',
        duration: 18,
        uploadDate: UPLOAD_DATE,
    },
    '/for-job-seekers': {
    ...
    '/faq': {
        ...
        title: 'NP Hiring FAQ — Frequently Asked Questions',
        description: 'Answers to common questions about NP Hiring — job posting, salary transparency, job alerts, employer features, and how the platform works.',
        duration: 17,
        uploadDate: UPLOAD_DATE,
    },
    '/contact': {
        ...
        title: 'Contact NP Hiring Support',
        description: 'Get in touch with the NP Hiring support team for help with job postings, account issues, or general inquiries.',
        duration: 17,
        uploadDate: UPLOAD_DATE,
    },
    '/privacy': {
        ...
        title: 'NP Hiring Privacy Policy',
        description: 'Review the NP Hiring privacy policy — how we collect, use, and protect your personal information on our psychiatric nurse practitioner job board.',
        duration: 30,
        uploadDate: UPLOAD_DATE,
    },
    '/terms': {
        ...
        title: 'NP Hiring Terms of Service',
        description: 'Read the NP Hiring terms of service covering user rights, employer responsibilities, job posting guidelines, and platform usage policies.',
        duration: 28,
        uploadDate: UPLOAD_DATE,
    },
    '/resources': {
    ...
    '/post-job': {
        ...
        description: 'Post a psychiatric nurse practitioner job on NP Hiring. Reach thousands of qualified PMHNPs with targeted job listings, salary transparency, and employer branding.',
        duration: 19,
        uploadDate: UPLOAD_DATE,
    },
    '/job-alerts': {
