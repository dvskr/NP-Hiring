...
description: Psychiatric-mental health became a two-body track in 2024. ANCC's long-established PMHNP-BC and AANPCB's newer, dual-accredited PMHNP-C now certify the same population focus. This guide covers the eligibility mechanics both exams share, what the second body changes, how renewal works, and how to choose with your state board's accepted list in hand.
...
- Your **state license renews separately**, on its own clock and under its own CE rules. The [state-by-state CE hub](/blog/np-ceu-requirements-by-state) links each board's current requirements.
- Keep certification renewal, license renewal, and DEA registration on one calendar. The [credentialing checklist](/blog/np-credentialing-checklist) shows how a lapse in any one of them stalls employment paperwork, because verifiers check all three at the source.
