...
description: The 40 questions nurse practitioner candidates are actually asked, covering clinical judgment, behavioral, scope and autonomy, and compensation. Each comes with a sample answer you can adapt, plus the questions worth asking back.
...
Before the interview, confirm the practice-authority rules in the state where you are interviewing, because half the scope questions below hinge on them. Our [state licensure guides](/resources) cover all 51 jurisdictions.
...
When you are ready to line up interviews, browse [open positions](/jobs) and set a [job alert](/job-alerts) so new roles in your specialty reach you first. Bring a resume that survives the ATS parse (see the [NP resume guide](/blog/np-resume-guide)) and a tailored [cover letter](/blog/np-cover-letter-guide).
