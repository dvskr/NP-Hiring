...
description: Two bodies certify family nurse practitioners: AANPCB (FNP-C) and ANCC (FNP-BC). The eligibility mechanics both share, where the exams differ as the bodies themselves describe them, how renewal works, and a decision framework that starts with your state board rather than a forum thread.
...
**Quick answer:** Family practice is the NP track with the longest-running choice of certifying body: the American Academy of Nurse Practitioners Certification Board (AANPCB) awards FNP-C, and the American Nurses Credentialing Center (ANCC) awards FNP-BC. Both certify the same population focus, family and individual care across the lifespan, and your scope of practice comes from state law and your license, not from the body that printed your certificate. Make the decision with three sources: your state board's published list of accepted certifications, each body's own candidate handbook and test content outline, and your program's guidance. Everything else is secondary.

---

## One population focus, two certifying bodies

Some NP tracks route to a single certifying body: pediatrics runs through the [PNCB](https://www.pncb.org/), and neonatal and women's health run through the [NCC](https://www.nccwebsite.org/). Where a body choice exists, it follows the template family practice set: adult-gerontology pairs bodies on [each side of its acuity split](/blog/agacnp-vs-agpcnp), and psychiatric-mental health [gained a second body in 2024](/blog/pmhnp-certification-guide). Family practice is where the pattern is oldest and the volume is highest: two independent, nationally recognized bodies both certify the FNP population focus, and the credential letters follow the body.

- **[AANPCB](https://www.aanpcert.org/)** is the American Academy of Nurse Practitioners Certification Board, the independent certification body affiliated with the American Association of Nurse Practitioners. Its family credential is FNP-C.
- **[ANCC](https://www.nursingworld.org/ancc/)** is the American Nurses Credentialing Center, the credentialing arm affiliated with the American Nurses Association. Its family credential is FNP-BC.
...
- Put certification renewal, license renewal, and DEA registration in one calendar. A lapsed credential stalls employment paperwork exactly the way a lapsed license does. The [credentialing checklist](/blog/np-credentialing-checklist) covers what verifiers check.
...
4. **Ask a target employer, if you have one.** Credentialing offices answer this question definitively and at no cost. For nearly everyone it is a non-issue, but if a specific health system or federal employer is the goal, ask that employer rather than an online forum.
5. **Then stop optimizing.** The [family practice job market](/jobs/family-practice) hires both credentials, and the [FNP salary page](/salary-guide/specialty/family-practice) shows what the roles pay. The population focus you chose (see the [FNP vs PMHNP vs AGACNP comparison](/blog/fnp-vs-pmhnp-vs-agacnp)) shapes your career far more than the letters after it.
